...
const Login = () => {
  ...
  return (
    <Container>
      <Box sx={{ width: "18%", marginX: "auto", marginY: "50px" }}>
        <img
          style={{ width: "100%" }}
      ...
      <p style={{textAlign: 'center'}}>dont have an account ? <Link to="/register">create one</Link></p>
      <p style={{textAlign: 'center', marginTop: '30px', marginBottom: '15px'}}>-------------------- or --------------------</p>
        <Box style={{width: '50%', margin: 'auto', marginY: '10px'}}>
